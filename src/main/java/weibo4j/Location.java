...
public class Location extends Weibo {
    ...
    public JSONObject getMapImageByCenter(String centerCoordinate) throws WeiboException {
        return client
            .get(WeiboConfig.getOpenAPIBaseURL() + "location/base/get_map_image.json",
                new PostParameter[] {new PostParameter("center_coordinate", centerCoordinate)}, accessToken)
            .asJSONObject();
    }
    ...
    public JSONObject getMapImageByCity(String city) throws WeiboException {
        return client.get(WeiboConfig.getOpenAPIBaseURL() + "location/base/get_map_image.json",
            new PostParameter[] {new PostParameter("city", city)}, accessToken).asJSONObject();
    }
    ...
    public JSONObject getMapImage(Map<String, String> map) throws WeiboException {
        ...
        return client.get(WeiboConfig.getOpenAPIBaseURL() + "location/base/get_map_image.json", parList, accessToken)
            .asJSONObject();
    }
    ...
    public List<Geos> ipToGeo(String ip) throws WeiboException {
        return WeiboResponse.buildList(client.get(WeiboConfig.getOpenAPIBaseURL() + "location/geo/ip_to_geo.json",
            new PostParameter[] {new PostParameter("ip", ip)}, accessToken), "geos", Geos.class);
    }
    ...
    public List<Poisition> searchPoisByLocationByCategory(String category) throws WeiboException {
        return Poisition
            .constructPois(client.get(WeiboConfig.getOpenAPIBaseURL() + "location/pois/search/by_location.json",
                new PostParameter[] {new PostParameter("category", category)}, accessToken));
    }
    ...
    public List<Poisition> searchPoisByLocation(Map<String, String> map) throws WeiboException {
        ...
        return Poisition.constructPois(client
            .get(WeiboConfig.getOpenAPIBaseURL() + "location/pois/search/by_location.json", parList, accessToken));
    }
    ...
    public JSONObject searchPoisByGeoByQ(String q) throws WeiboException {
        return client.get(WeiboConfig.getOpenAPIBaseURL() + "location/pois/search/by_geo.json",
            new PostParameter[] {new PostParameter("q", q)}, accessToken).asJSONObject();
    }
    ...
    public Poisition addPois(String srcid, String name, String address, String cityName, String category,
        ...
        return new Poisition(client.post(WeiboConfig.getOpenAPIBaseURL() + "location/pois/add.json",
    ...
    public Poisition addPois(Map<String, String> map) throws WeiboException {
        ...
        return new Poisition(
            client.post(WeiboConfig.getOpenAPIBaseURL() + "location/pois/add.json", parList, accessToken));
    }
    ...
    public JSONObject getLocation(String json) throws WeiboException {
        return client.post(WeiboConfig.getOpenAPIBaseURL() + "location/mobile/get_location.json",
            new PostParameter[] {new PostParameter("json", json)}, accessToken).asJSONObject();
    }
    ...
    public JSONObject searchBusRouteByCoordinate(String beginCoordinate, String endCoordinate) throws WeiboException {
        return client.get(WeiboConfig.getOpenAPIBaseURL() + "location/line/bus_route.json", new PostParameter[] {
            new PostParameter("begin_coordinate", beginCoordinate), new PostParameter("end_coordinate", endCoordinate)},
            accessToken).asJSONObject();
    }
    ...
    public JSONObject searchBusRoute(Map<String, String> map) throws WeiboException {
        PostParameter[] parList = ArrayUtils.mapToArray(map);
        return client.get(WeiboConfig.getOpenAPIBaseURL() + "location/line/bus_route.json", parList, accessToken)
            .asJSONObject();
    }
    ...
    public JSONObject searchBusLine(String q) throws WeiboException {
        return client.get(WeiboConfig.getOpenAPIBaseURL() + "location/line/bus_line.json",
            new PostParameter[] {new PostParameter("q", q)}, accessToken).asJSONObject();
    }
    ...
    public JSONObject searchBusLine(Map<String, String> map) throws WeiboException {
        PostParameter[] parList = ArrayUtils.mapToArray(map);
        return client.get(WeiboConfig.getOpenAPIBaseURL() + "location/line/bus_line.json", parList, accessToken)
            .asJSONObject();
    }
    ...
    public JSONObject searchBusStation(String q) throws WeiboException {
        return client.get(WeiboConfig.getOpenAPIBaseURL() + "location/line/bus_station.json",
            new PostParameter[] {new PostParameter("q", q)}, accessToken).asJSONObject();
    }
    ...
    public JSONObject searchBusStation(Map<String, String> map) throws WeiboException {
        PostParameter[] parList = ArrayUtils.mapToArray(map);
        return client.get(WeiboConfig.getOpenAPIBaseURL() + "location/line/bus_station.json", parList, accessToken)
            .asJSONObject();
    }
